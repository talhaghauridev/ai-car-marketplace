...
function EmiCalculator({ price = 1000 }: EmiCalculatorProps) {
  ...
  const calculateLoan = (principal: number, down: number, rate: number, years: number): void => {
    ...
    <div className="w-full max-h-[80vh] overflow-y-auto pr-1">
      <div className="w-full">
        ...
        <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="relative">
                  <input
                    type="number"
                    value={loanTenure}
                    onChange={(e) => handleLoanTenureChange(parseFloat(e.target.value) || 0)}
          ...
          {error && <div className="text-red-500 dark:text-red-400 text-sm mt-3">{error}</div>}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg md:col-span-2">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                    $
                    {formatNumber(
                      parseFloat(results.downPayment) + parseFloat(results.totalPayment)
                    )}
                  </div>
                </div>
              </div>
